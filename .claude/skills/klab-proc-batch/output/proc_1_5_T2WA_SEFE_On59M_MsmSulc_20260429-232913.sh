...
for sbjid in ${subjects[@]}; do
    tsp bash startAggregationOfLgiOnMmp1ForKlab.sh \
        --subject-id=${sbjid} \
        --drv-of-subjects-on-share=/mnt/synology4-1/HCP_postFS/03_Adolescence_taste/LegacyStyle_with_Topup/derivatives/HCPpipeline \
        --drv-of-subjects-on-proc=/mnt/data2/iueda/1_5_T2WA_SEFE/derivatives \
